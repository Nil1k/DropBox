            ...
            <div className="container mt-5 ">
                <div className="row">
                    <div className="col-md-6 d-flex flex-column justify-content-center">
                        ...
                        <p>Dropbox is made from the pain of writing all the things in notebook which is very hectic, So we mad an online web platform where you can create, edit, upload, delete your notes/information privately and securely without any disturbancee.
                ...
                <div className="row login mt-5 mb-5 p-5">
                    ...
                    <div className="col-md-6 d-flex flex-column justify-content-center">
                        ...
                        <p>
                            How we started? The concept was simple. Dropbox was born from the pain of writing all the things in notebook which is very hectic .
            ...
            <footer>
                <div className="content">
                    <div className="top">
                        <div className="logo-details">
                            <span className="logo_name">Dropbox</span>
                        </div>
                    ...
                    <div className="link-boxes">
                        ...
                        <ul className="box input-box">
                            <li className="link_name">About Dropbox</li>
                ...
                <div className="bottom-details">
                    <div className="bottom_text">
                        <span className="copyright_text">Copyright © 2022 <Link to="/">Dropbox</Link>All rights reserved</span>
